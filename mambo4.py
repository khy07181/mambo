...
mamboAddr = "D0:3A:56:CA:E6:36"	#772524 is "D0:3A:56:CA:E6:36"
			...
			if (success):
				...
				while True:
					if (data[-1]=='-1T'): #Takeoff
						...
						dance_1R(mambo,conn1, data)
						data.append('1000')
						print("Waiting for command Current Data : "+data[-1])
					elif (data[-1]=='2-1'):#Dance2
						dance_2R(mambo,conn1, data)
						data.append('1000')
						print("Waiting for command Current Data : "+data[-1])
					elif (data[-1]=='3-1'):#Dance3
						dance_3R(mambo,conn1, data)
						data.append('1000')
						print("Waiting for command Current Data : "+data[-1])
						...
						if (mambo.sensors.flying_state != "emergency"):
							...
							data.append('1000')
							print("Waiting for command Current Data : "+data[-1])
					elif (data[-1]=='05'or data[-1]=='454'):# Minus Pitch
						if (mambo.sensors.flying_state != "emergency"):
							mambo.fly_direct(roll=0, pitch=-30, yaw=0, vertical_movement=0, duration=0.7)
							mambo.smart_sleep(1)
							data.append('1000')
							print("Waiting for command Current Data : "+data[-1])
					elif (data[-1]=='0P'or data[-1]=='4P4'):# Plus Pitch
						if (mambo.sensors.flying_state != "emergency"):
							mambo.fly_direct(roll=0, pitch=30, yaw=0, vertical_movement=0, duration=0.7)
							mambo.smart_sleep(1)
							data.append('1000')
							print("Waiting for command Current Data : "+data[-1])
					elif (data[-1]=='0L'or data[-1]=='4L4'):# Minus Roll
						if (mambo.sensors.flying_state != "emergency"):
							mambo.fly_direct(roll=-30, pitch=0, yaw=0, vertical_movement=0, duration=0.7)
							mambo.smart_sleep(1)
							data.append('1000')
							print("Waiting for command Current Data : "+data[-1])
					elif (data[-1]=='0R'or data[-1]=='4R4'):# Plus Roll
						if (mambo.sensors.flying_state != "emergency"):
							mambo.fly_direct(roll=30, pitch=-0, yaw=0, vertical_movement=0, duration=0.7)
							mambo.smart_sleep(1)
							data.append('1000')
							print("Waiting for command Current Data : "+data[-1])
					elif (data[-1]=='01'or data[-1]=='414'):# left Turn
						if (mambo.sensors.flying_state != "emergency"):
							mambo.turn_degrees(90)
							mambo.smart_sleep(1)
							data.append('1000')
							print("Waiting for command Current Data : "+data[-1])
					elif (data[-1]=='02'or data[-1]=='424'):# Right turn
						if (mambo.sensors.flying_state != "emergency"):
							mambo.turn_degrees(-90)
							mambo.smart_sleep(1)
							data.append('1000')
							print("Waiting for command Current Data : "+data[-1])
					elif (data[-1]=='03'or data[-1]=='434'):# Flip
						if (mambo.sensors.flying_state != "emergency"):
