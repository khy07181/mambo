...
mamboAddr = "D0:3A:4A:72:E6:36"		#772483 is "D0:3A:4A:72:E6:36"	
				...
				while True:
					if (data[-1]=='-1T'): #Takeoff
						...
						if (mambo.sensors.flying_state != "emergency"):
							...
							data.append('1000')
							print("Waiting for command Current Data : "+data[-1])
					elif (data[-1]=='05'or data[-1]=='453'):# Minus Pitch
						if (mambo.sensors.flying_state != "emergency"):
							mambo.fly_direct(roll=0, pitch=-30, yaw=0, vertical_movement=0, duration=0.7)
							mambo.smart_sleep(1)
							data.append('1000')
							print("Waiting for command Current Data : "+data[-1])
					elif (data[-1]=='0P'or data[-1]=='4P3'):# Plus Pitch
						if (mambo.sensors.flying_state != "emergency"):
							mambo.fly_direct(roll=0, pitch=30, yaw=0, vertical_movement=0, duration=0.7)
							mambo.smart_sleep(1)
							data.append('1000')
							print("Waiting for command Current Data : "+data[-1])
					elif (data[-1]=='0L'or data[-1]=='4L3'):# Minus Roll
						if (mambo.sensors.flying_state != "emergency"):
							mambo.fly_direct(roll=-30, pitch=0, yaw=0, vertical_movement=0, duration=0.7)
							mambo.smart_sleep(1)
							data.append('1000')
							print("Waiting for command Current Data : "+data[-1])
					elif (data[-1]=='0R'or data[-1]=='4R3'):# Plus Roll
						if (mambo.sensors.flying_state != "emergency"):
							mambo.fly_direct(roll=30, pitch=-0, yaw=0, vertical_movement=0, duration=0.7)
							mambo.smart_sleep(1)
							data.append('1000')
							print("Waiting for command Current Data : "+data[-1])
					elif (data[-1]=='01'or data[-1]=='413'):# left Turn
						if (mambo.sensors.flying_state != "emergency"):
							mambo.turn_degrees(90)
							mambo.smart_sleep(1)
							data.append('1000')
							print("Waiting for command Current Data : "+data[-1])
					elif (data[-1]=='02'or data[-1]=='423'):# Right turn
						if (mambo.sensors.flying_state != "emergency"):
							mambo.turn_degrees(-90)
							mambo.smart_sleep(1)
							data.append('1000')
							print("Waiting for command Current Data : "+data[-1])
					elif (data[-1]=='03'or data[-1]=='433'):# Flip
						if (mambo.sensors.flying_state != "emergency"):
